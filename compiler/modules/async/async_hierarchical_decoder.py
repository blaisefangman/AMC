...
from async_hierarchical_predecode3x8 import hierarchical_predecode3x8 as pre3x8
from async_decode_stage_4_4 import decode_stage_4_4
from async_decode_stage_5_4 import decode_stage_5_4
...
class hierarchical_decoder(design.design):
    ...
    def calculate_dimensions(self):
        ...
        self.routing_width = self.m1_pitch*self.num_of_predecoder_out
    ...
    def route_vdd_gnd(self):
        ...
        for mod in modules:
            for num in range(len(mod)):
                ...
                for pin in vdd_pin:
                    self.add_rect(layer=pin.layer[0:2],
                                  offset=(0, pin.by()),
                                  width=self.width,
    ...
    def connect_rail(self, rail_index, pin):
        ...
        self.add_path("m1", [rail_pos, (pin.uc().x, pin.lc().y)])
