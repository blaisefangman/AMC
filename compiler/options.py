...
class options(optparse.Values):
    ...
    # SHARED Sync and Async options

    # This is the technology directory.
    openram_tech = ""

    # Generate Synchronous ("sync") or Asynchronous ("async") memory
    # If "async" is wanted, need to set this value using the command line option -a
    # because OPTS.mode is used before user config file is read
    mode = "sync"
    ...
    try:
        ...
        openram_temp = os.path.abspath(os.environ.get("AMC_TMP"))
    ...
    # Keep the temp directory after a successful
