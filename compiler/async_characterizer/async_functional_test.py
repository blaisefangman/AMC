...
from os import path
from . import async_charutils 
import numpy as np
from globals import OPTS, get_tool
import time
import design
import math
from . import async_trim_spice
...
class functional_test():
    ...
    def run_sim(self, load, slew):
        ...
        write_delay = async_charutils.parse_output("test", "write_delay")
        read_delay = async_charutils.parse_output("test", "read_delay")
        read_write_delay = async_charutils.parse_output("test", "read_write_delay")
        slew_hl = async_charutils.parse_output("test", "slew_hl")
        slew_lh = async_charutils.parse_output("test", "slew_lh")
        leakage_power = async_charutils.parse_output("test", "leakage_power")
        write_power = async_charutils.parse_output("test", "write_power")
        read_power = async_charutils.parse_output("test", "read_power")
        read_write_power = async_charutils.parse_output("test", "read_write_power")
